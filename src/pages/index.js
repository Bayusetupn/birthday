      ...
      <div className=" overflow-hidden">
        ...
        <div className="relative w-[100vw] h-[100vh]">
          ...
          <Image
            src={lamp}
            alt="lamp"
            className="absolute lg:-mt-4 object-cover w-[250%] lg:w-[100%] z-10"
          />
          <Image
            src={love1}
            alt="love"
            className="absolute w-[80%] -top-10 lg:top-0 -left-16 lg:left-0 lg:w-[30%] z-10"
          />
          ...
          <div className="absolute w-[100vw] flex flex-col-reverse justify-center items-center h-[100vh] z-10 md:flex-col lg:flex-row">
            <m.div
              ...
              className="items-start w-[80%] lg:w-[40%] justify-center flex flex-col"
            >
            ...
            <m.div
              ...
              animate={{ y: 0, opacity: 1 }}
              transition={{ ease: "easeIn", duration: 0.5 }}
              className="w-[75%] mb-10 lg:mb-0 lg:w-[25%] z-20"
              onClick={afterClick}
            >
        ...
        <div className="mt-5 mb-16 relative w-[100vw]">
          <div className="w-[100%] text-center flex flex-col justify-center items-center">
            ...
            <m.div
              ...
              className="w-[100%] lg:w-[30%] mt-10 z-20 "
            >
              <ReactCardFlip
                isFlipped={flip}
            ...
            <Image
              src={loveMsg}
              className="absolute lg:block hidden w-[10%] right-64"
            />
            <Image
              src={loveMsg}
        ...
        <div className="mt-5 relative w-[100vw] flex flex-col items-center text-center">
          ...
          <div className="flex flex-col lg:flex-row w-[90%] justify-center items-center">
            <m.div className="w-[100%]" initial={{x:-20,opacity: 0}} whileInView={{x: 0,opacity: 1}} transition={{ease: "easeInOut",duration: 0.75}}>
              <Image src={one} className="w-[100%]" />
            </m.div>
            <m.div initial={{y:-20,opacity: 0}} whileInView={{y: 0,opacity: 1}} transition={{ease: "easeInOut",duration: 1}} className="w-[100%]">
              <Image src={two} className="w-[100%]" />
            </m.div>
            <m.div initial={{x:20,opacity: 0}} whileInView={{x: 0,opacity: 1}} transition={{ease: "easeInOut",duration: 1}} className="w-[100%]">
          ...
          <Image
            src={love2}
            className="absolute w-[70%] lg:w-[40%] -right-10 lg:right-0 lg:bottom-0 bottom-20 -scale-x-100"
          />
          <Image
            src={love2}
            className="absolute w-[70%] lg:w-[40%] lg:left-0 -left-10 lg-bottom-0 bottom-20"
          />
        </div>
      </div>
    </LazyMotion>
